...
const NewRoom = () => {
  ...
  const [newRoom, { isLoading, isSuccess, error }] = useNewRoomMutation();

  useEffect(() => {
    if (error && 'data' in error) {
      toast.error(error?.data?.errMessage[0]);
    }
          ...
          <div className="row">
            <div className="mb-3 col">
              ...
              <select
                ...
                onChange={onChange}
              >
                {guestCapacityOptions.map((option, ind) => {
                  return (
                    <option value={option} key={option}>
                      {option}
                    </option>
            ...
            <div className="mb-3 col">
              ...
              <select
                ...
                onChange={onChange}
              >
                {numOfBedsOptions.map((option, ind) => {
                  return (
                    <option value={option} key={option}>
                      {option}
                    </option>
